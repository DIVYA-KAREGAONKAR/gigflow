          ...
          <form onSubmit={submit} className="space-y-8">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full bg-transparent border-b-2 border-slate-200 py-3 text-xl font-bold placeholder:text-slate-300 focus:border-indigo-600 focus:outline-none transition-all"
            ...
            <div className="space-y-2">
              ...
              <select
                className="w-full bg-white border border-slate-200 p-4 rounded-2xl text-lg font-bold text-slate-700 shadow-sm focus:border-indigo-600 focus:outline-none transition-all appearance-none cursor-pointer"
